...
# Subplot 1 of 4
axes[0][0].plot(np.sin(hole_radius_array),np.asarray([np.percentile(rel_pol_area[index],50) for index in range(len(rel_pol_area))]),'-',color=(0/256,68/256,27/256),label="Total pole area in \\%")
axes[0][0].plot(np.sin(hole_radius_array),np.asarray([np.percentile(rel_pol_area[index],95) for index in range(len(rel_pol_area))]),'-',color=(0/256,68/256,27/256))
axes[0][0].plot(np.sin(hole_radius_array),np.asarray([np.percentile(rel_pol_area[index],5) for index in range(len(rel_pol_area))]),'-',color=(0/256,68/256,27/256))
axes[0][0].fill_between(np.sin(hole_radius_array),np.asarray([np.percentile(rel_pol_area[index],5) for index in range(len(rel_pol_area))]),np.asarray([np.percentile(rel_pol_area[index],95) for index in range(len(rel_pol_area))]), facecolor=(0/256,68/256,27/256),alpha=0.5,interpolate=True)
axes[0][0].legend(loc='best')
axes[0][0].set_ylim([0,100])
axes[0][0].yaxis.set_ticks(np.arange(0,110,10))
axes[0][0].set_xlim([0,np.sin(hole_radius_array)[-1]])
# We change the fontsize of minor ticks label 
axes[0][0].tick_params(axis='both', which='major', labelsize=15)
axes[0][0].tick_params(axis='both', which='minor', labelsize=15)

# Subplot 2 of 4
axes[0][1].plot(np.sin(hole_radius_array),np.asarray([np.percentile(num_poles_vec[index],50) for index in range(len(num_poles_vec))]),'-',color=(77/256,0/256,75/256),label="Number of poles")
axes[0][1].plot(np.sin(hole_radius_array),np.asarray([np.percentile(num_poles_vec[index],95) for index in range(len(num_poles_vec))]),'-',color=(77/256,0/256,75/256))
axes[0][1].plot(np.sin(hole_radius_array),np.asarray([np.percentile(num_poles_vec[index],5) for index in range(len(num_poles_vec))]),'-',color=(77/256,0/256,75/256))
axes[0][1].fill_between(np.sin(hole_radius_array),np.asarray([np.percentile(num_poles_vec[index],5) for index in range(len(num_poles_vec))]),np.array([np.percentile(num_poles_vec[index],95) for index in range(len(num_poles_vec))]), facecolor=(77/256,0/256,75/256),alpha=0.5,interpolate=True)
axes[0][1].legend(loc='best')
axes[0][1].set_ylim([0,5])
axes[0][1].set_xlim([0,np.sin(hole_radius_array)[-1]])
axes[0][1].tick_params(axis='both', which='major', labelsize=15)
axes[0][1].tick_params(axis='both', which='minor', labelsize=15)
# Subplot 3 of 4
axes[1][0].plot(np.sin(hole_radius_array),np.asarray([np.percentile(max_conc[index],50) for index in range(len(max_conc))]),'-',color=(129/256,15/256,124/256),label="Max. conc.")
axes[1][0].plot(np.sin(hole_radius_array),np.asarray([np.percentile(max_conc[index],95) for index in range(len(max_conc))]),'-',color=(129/256,15/256,124/256))
axes[1][0].plot(np.sin(hole_radius_array),np.asarray([np.percentile(max_conc[index],5) for index in range(len(max_conc))]),'-',color=(129/256,15/256,124/256))
axes[1][0].fill_between(np.sin(hole_radius_array),np.asarray([np.percentile(max_conc[index],5) for index in range(len(max_conc))]),np.array([np.percentile(max_conc[index],95) for index in range(len(max_conc))]), facecolor=(129/256,15/256,124/256),alpha=0.5,interpolate=True)
axes[1][0].legend(loc='best')
axes[1][0].set_ylim([0,2])
axes[1][0].set_xlim([0,np.sin(hole_radius_array)[-1]])
axes[1][0].tick_params(axis='both', which='major', labelsize=15)
axes[1][0].tick_params(axis='both', which='minor', labelsize=15)
# Subplot 4 of 4
axes[1][1].plot(np.sin(hole_radius_array),np.asarray([np.percentile(min_dist[index],50) for index in range(len(min_dist))]),'-',color=(64/256,0/256,125/256),label="Min. dist.")
axes[1][1].plot(np.sin(hole_radius_array),np.asarray([np.percentile(min_dist[index],95) for index in range(len(min_dist))]),'-',color=(64/256,0/256,125/256))
axes[1][1].plot(np.sin(hole_radius_array),np.asarray([np.percentile(min_dist[index],5) for index in range(len(min_dist))]),'-',color=(64/256,0/256,125/256))
axes[1][1].fill_between(np.sin(hole_radius_array),np.asarray([np.percentile(min_dist[index],5) for index in range(len(min_dist))]),np.array([np.percentile(min_dist[index],95) for index in range(len(min_dist))]), facecolor=(64/256,0/256,125/256),alpha=0.5,interpolate=True)
axes[1][1].legend(loc='best')
axes[1][1].set_ylim([0,4])
axes[1][1].yaxis.set_ticks(np.arange(0,4.5,0.5))
axes[1][1].set_xlim([0,np.sin(hole_radius_array)[-1]])
