...
If you wish to save a particular initial condition to a file, you can run the script "*fix\_initial\_condition.py*". After this, you can alter the sixth or, if you will, second last argument on the lines 72 and 75 in the script "*launch\_simulations\_Schnakenberg\_sphere\_with\_holes.py*" from "*True*" to "*False*". In this case, the simulations will be conducted on the same initial condition, and if you conduct simulations on meshes with a hole at the south pole the saved initial condition will be projected onto these meshes. 
