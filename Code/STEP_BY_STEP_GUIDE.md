...
Now, we would like to generate 15 meshes where the cylindrical radii of the single holes located at the south pole are given by r=0,0.05,0.10,...,0.70. This is achieved by running the script
