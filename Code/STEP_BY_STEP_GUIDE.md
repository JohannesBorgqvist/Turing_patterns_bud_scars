...
To visualise the eigenfunctions of the Laplace-Beltrami operator, you can run the script *visualise\_eigenfunctions.py*. This script project the eigenfunctions onto the mesh with no holes, corresponding to the mesh that approximated the unit sphere. The files that are generated by this script are stored in the Output folder, and they can be looked at in ParaView.
